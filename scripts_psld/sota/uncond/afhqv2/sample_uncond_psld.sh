...
python main/eval/sample.py +dataset=afhqv2/afhqv2128_psld \
                     ...
                     dataset.diffusion.evaluation.save_path=\'/home/pandeyk1/psld_results/sota/uncond/afhq128/psld_hsm_gamma=0.01_nu=4.01_afhq128_continuous_sfn=ncsnpp/samples_5k/epoch=2250/em_quad/\' \
                     dataset.diffusion.evaluation.batch_size=3 \
                     ...
                     dataset.diffusion.evaluation.chkpt_path=\'/home/pandeyk1/psld_results/sota/uncond/afhq128/psld_hsm_gamma=0.01_nu=4.01_afhq128_continuous_sfn=ncsnpp/checkpoints/psld-hsm_sota_gamma=0.01_nu=4.01_afhq128_7thJun23_nf=160_chmult=12233-epoch=2249-loss=0.0025.ckpt\' \
