python main/train_sde.py +dataset=afhqv2/afhqv2128_psld \
                     ...
                     dataset.diffusion.training.results_dir=\'/home/pandeyk1/psld_results/sota/uncond/afhq128/psld_hsm_gamma=0_nu=4.0_afhq128_continuous_sfn=ncsnpp/\' \
                     dataset.diffusion.training.workers=1 \
                     dataset.diffusion.training.chkpt_prefix=\"hsm_sota_gamma=0_nu=4.0_afhq128_25May23_nf=160_chmult=12233\"