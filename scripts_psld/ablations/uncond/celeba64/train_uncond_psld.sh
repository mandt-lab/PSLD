python main/train_sde.py +dataset=celeba64/celeba64_psld \
                     ...
                     dataset.diffusion.model.sde.nu=4.25 \
                     dataset.diffusion.model.sde.gamma=0.25 \
                     ...
                     dataset.diffusion.training.epochs=200 \
                     dataset.diffusion.training.accelerator='gpu' \
                     dataset.diffusion.training.devices=4 \
                     dataset.diffusion.training.results_dir=\'/home/pandeyk1/psld_results/ablations/uncond/celeba64/psld_hsm_gamma=0.01_nu=4.01_celeba64_continuous_sfn=ncsnpp/\' \
                     dataset.diffusion.training.workers=1 \
                     dataset.diffusion.training.chkpt_prefix=\"hsm_ablation_gamma=0.01_nu=4.01_celeba64_27thJan23\"