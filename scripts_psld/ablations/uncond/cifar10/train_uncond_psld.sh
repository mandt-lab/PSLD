python main/train_sde.py +dataset=cifar10/cifar10_psld \
                     ...
                     dataset.diffusion.training.results_dir=\'/home/pandeyk1/psld_results/ablations/uncond/cifar10/psld_hsm_gamma=0.02_nu=4.02_decomp=upper_cifar10_continuous_sfn=ncsnpp/\' \
                     dataset.diffusion.training.workers=1 \
                     dataset.diffusion.training.chkpt_prefix=\"hsm_ablation_gamma=0.02_nu=4.02_decomp=lower_cifar10_14thFeb23\"
